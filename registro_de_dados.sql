...
BEGIN	
	...
	ELSIF (DESCRICAO IS NULL) THEN
		RAISE EXCEPTION 'INFORME OS DESCRICAO DO PRODUTO';
	ELSE
		INSERT INTO PRODUTO(NOME, DESCRICAO)
		VALUES(NOME, DESCRICAO);
		RAISE INFO 'PRODUTO ADICIONADO COM SUCESSO';
	END IF;

END $$ LANGUAGE PLPGSQL;

SELECT ADICIONAR_PRODUTO('HEADSET OEX HS208', 'Extra conforto, Conector p2, Preto com vermelho, Comprimento do cabo: 1.2m');